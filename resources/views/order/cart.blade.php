    ...
    <main class="container" role="main">
        <form class="product-cart" action="{{ route('ajax.cart.edit') }}" method="post">
            ...
            <div class="product-cart-footer container-in">
                @if($products->count())
                    <!-- Checkout-->
                    <button class="btn btn_green product-cart-footer__checkout">Оформить заказ
                    </button>
                    <!-- Quick buy-->
                    <button class="btn btn_yellow product-cart-footer__quick-buy js-fast-order">Купить сейчас
                    </button>
