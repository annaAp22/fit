        ...
        <div class="checkout-body container-in">
            ...
            <form class="checkout-form" action="{{ route('order.details') }}" method="post">
                ...
                <div class="form-footer js-step js-step js-step_2 active">
                    <!-- Step 1-->
                    <div class="container-in js-step js-step_1 active">
                        <button class="btn btn_green form-footer__btn form-footer__btn_step-1 js-step-next" data-next_step="2" disabled><span>Подтвердить</span><i class="sprite_main sprite_main-icon-arrow-small-right-dark-green"></i>
                        </button>
