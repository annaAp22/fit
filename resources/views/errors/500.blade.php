        ...
        <div class="main-content-5">
            ...
            <section class="page-404">
                <div class="allocate child v-b">
                    <h1 class="total-c-10">Ошибка 500</h1>&#10;
                </div>
                <div class="block-1">
                ...
                <div class="error-win">
                    ...
                    <div class="d">Похоже, на сервере произошла ошибка.<br/> Не беда. Попробуйте воспользоваться поиском или начните просмотр каталога </div>
