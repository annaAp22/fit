                ...
                <div class="container-in">
                    ...
                    @if($products->currentPage() < $products->lastPage())
                        <div class="page-navigation">
                            <button class="btn btn_more js-action-link" data-text="{{$text}}" data-action="{{route('search')}}" data-page="{{$products->currentPage() + 1}}">
                            ...
                            <button class="btn btn_show-all js-action-link" data-per_page="all"  data-text="{{$text}}" data-action="{{route('search')}}">
