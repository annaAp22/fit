...
@section('main')
    ...
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Предложения для категорий</li>
        </ul><!-- /.breadcrumb -->
                ...
                <div class="tabbable">
                        ...
                        <div class="table-header">
                            ...
                            <div class="ibox-tools">
                                <a href="{{route('admin.offers.create')}}" class="btn btn-success btn-xs">
                            ...
                            <div class="row">
                                <form method="GET" action="{{route('admin.offers.index')}}">
                                                ...
                                                <label>Категория:
                                                    <select name="f[id_category]" id="form-field-20">
                                                        ...
                                                        @foreach($categories as $category)
                                                            ...
                                                            @include('admin.offers.dropdown', ['cats' => $category->children, 'index' => 1])
                                                            @endif
                                                        @endforeach
                                                    </select>
                                                </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            <div>
                                                <a class="btn  btn-xs" href="{{route('admin.offers.index')}}?refresh=1">
                                                    Сбросить
                                    ...
                                    <tr @if($item->trashed())style="background-color: #F6CECE"@endif>
                                        <td>
                                            @if($item->image)
                                                <a data-rel="colorbox" href="{{$item->uploads->image->url()}}">
                                                    <img src="{{$item->uploads->image->preview->url()}}" width="231" />
                                                </a>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs btn-group">
                                                @if($item->trashed())
                                                <form method="POST" action='{{route('admin.offers.restore', $item->id)}}' style="display:inline;">
                                                ...
                                                @else
                                                <a class="btn btn-xs btn-info" href="{{route('admin.offers.edit', $item->id)}}">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>
                                                <form method="POST" action='{{route('admin.offers.destroy', $item->id)}}' style="display:inline;">
