...
@section('main')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Добавление настройки</li>
        </ul><!-- /.breadcrumb -->
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" action="{{route('admin.settings.store')}}" method="POST">
                    <input name="_token" type="hidden" value="{{csrf_token()}}">

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-0"> Название</label>
                        <div class="col-sm-9">
                            <input type="text" id="form-field-0" name="var" placeholder="Название" value="{{ old('var') }}" class="col-sm-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="radio">
                                <label>
                                    <input name="type" type="radio" class="ace check-vision" value="string" data-name="string-group" @if(!old() || old('type') == 'string') checked="checked" @endif  >
                                    <span class="lbl"> Строка</span>
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input name="type" type="radio" class="ace check-vision" value="array" data-name="array-group" @if(old('type') == 'array') checked="checked" @endif >
                    ...
                    <div class="form-group vision-group string-group" @if(old('type') == 'array')style="display:none;" @endif>
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-3"> Значение</label>
                        <div class="col-sm-9">
                            <input type="text" id="form-field-3" name="value" placeholder="Значение" value="{{ old('value') }}" class="col-sm-12">
                        </div>
                    </div>

                    <div class="form-group vision-group array-group" @if(old('type') != 'array')style="display:none;" @endif>
