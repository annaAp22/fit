    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12 ace-thumbnails">
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" action="{{route('admin.deliveries.update', $delivery->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-10"> Цена </label>
                            <div class="col-sm-9">
                                <div class="col-sm-2 input-group">
                                    <input name="price" value="{{old('price', $delivery->price)}}" placeholder="Цена" type="text" id="form-field-10" class="input-number form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="form-field-17" name="descr" placeholder="Описание" class="col-sm-12">{{ old('descr', $delivery->descr) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <label>
                                ...
                                <input name="status" @if ((old() && old('status')) || (empty(old()) && $delivery->status) ) checked="checked" @endif   value="1" class="ace ace-switch ace-switch-4 btn-empty" type="checkbox">
                                <span class="lbl"></span>
                            </label>
                        </div>
                    </div>
