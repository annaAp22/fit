                                    ...
                                    <tr @if($item->trashed())style="background-color: #F6CECE"@endif>
                                        ...
                                        <td>
                                            @if($item->products->count())
                                                ...
                                                <a class="btn btn-minier btn-info" href="{{route('admin.products.index')}}?f[tag]={{$item->id}}" title="Товары с тэгом">
                                                    <i class="ace-icon fa fa-pencil"></i>
                                                </a>
                                                <a class="btn btn-minier btn-pink" href="{{route('admin.products.tag.sort', $item->id)}}" title="Сортировка внутри тэга">
                                                    <i class="ace-icon glyphicon glyphicon-list-alt"></i>
                                                </a>
                                            @endif
                                            <a class="btn btn-minier" href="{{route('admin.tags.products', $item->id)}}" title="Привязка товаров">
