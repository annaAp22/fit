...
@section('main')
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" action="{{route('admin.shops.store')}}" method="POST" enctype="multipart/form-data">
                    <input name="_token" type="hidden" value="{{csrf_token()}}">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right">Название</label>
                        <div class="col-sm-9">
                            <input type="text" name="title" placeholder="Название" value="{{ old('title') }}" class="col-sm-5" required/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="address" placeholder="Название" value="{{ old('address') }}" class="col-sm-5">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right">Телефон</label>
                        <div class="col-sm-9">
                            <input type="text" name="phone" placeholder="Телефон" value="{{ old('phone') }}" class="col-sm-5">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right">Email</label>
                        <div class="col-sm-9">
                            <input type="text" name="email" placeholder="shop@mail.ru" value="{{ old('email') }}" class="col-sm-5">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right">Ссылка на магазин</label>
                        <div class="col-sm-9">
                            <input type="text" name="link" placeholder="Название" value="{{ old('link') }}" class="col-sm-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="long" placeholder="0.0" value="{{ old('long') }}" class="col-sm-5" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="lat" placeholder="0.0" value="{{ old('long') }}" class="col-sm-5" required/>
                            <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="Используется для координат." title="">?</span>
                        </div>
                    </div>
                    <div class="form-group">
