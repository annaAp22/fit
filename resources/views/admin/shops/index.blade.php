            ...
            <div class="col-xs-12">
                ...
                <div class="table-header">
                    ...
                    <div class="ibox-tools">
                        <a href="{{route('admin.shops.create')}}" class="btn btn-success btn-xs">
                        ...
                        <div class="row">
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                @forelse($items as $item)
                                    <tr>
                                        <td>
                                            <a href="{{route('admin.shops.edit', $item->id)}}">{{$item->title}}</a>
                                        </td>
                                        <td>{{$item->long}}</td>
                                        <td>{{$item->lat}}</td>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs btn-group">
                                                ...
                                                <a class="btn btn-xs btn-info" href="{{route('admin.shops.edit', $item->id)}}">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>
                                                @can('delete', new App\Models\Page())
                                                <form method="POST" action='{{route('admin.shops.destroy', $item->id)}}' style="display:inline;">
