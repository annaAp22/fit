...
@section('main')
    <div class="breadcrumbs" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{route('admin.categories.index')}}">Books</a>
            </li>
            <li class="active">Редактирование book</li>
        </ul><!-- /.breadcrumb -->
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12 ace-thumbnails">
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" action="{{route('admin.look_categories.update', $category->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="number" id="form-field-1" class="col-sm-1" name="sort" placeholder="Сортировка" value="{{ old('sort', $category->sort) }}">
                        </div>
                    </div>
