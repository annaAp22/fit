                ...
                <div class="tabbable">
                        ...
                        <div class="table-header">
                            ...
                            <div class="ibox-tools">
                                <a href="{{route('admin.brands.create')}}" class="btn btn-success btn-xs">
                            ...
                            <div class="row">
                                <form method="GET" action="{{route('admin.articles.index')}}">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            <div>
                                                <a class="btn  btn-xs" href="{{route('admin.brands.index')}}?refresh=1">
                                                    Сбросить
                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                @forelse($brands as $item)
                                    <tr @if($item->trashed())style="background-color: #F6CECE"@endif>
                                        <td>
                                            <a href="{{route('admin.brands.edit', $item->id)}}">{{$item->name}}</a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs btn-group">
                                                @if($item->trashed())
                                                <form method="POST" action='{{route('admin.brands.restore', $item->id)}}' style="display:inline;">
                                                ...
                                                @else
                                                <a class="btn btn-xs btn-info" href="{{route('admin.brands.edit', $item->id)}}">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>
                                                <form method="POST" action='{{route('admin.brands.destroy', $item->id)}}' style="display:inline;">
