...
@section('main')
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" action="{{route('admin.comments.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group col-sm-4">
                                <input class=" form-control date-picker" name="date" value="{{old('date', date('d.m.Y'))}}" id="form-field-1" type="text" data-date-format="dd.mm.yyyy" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="form-field-2" name="name" placeholder="Имя" value="{{ old('name') }}" class="col-sm-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="email" id="form-field-3" name="email" placeholder="E-mail" value="{{ old('email') }}" class="col-sm-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="form-field-17" name="text" placeholder="Текст" class="col-sm-12">{{ old('text') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="form-field-17" name="pros" placeholder="Достоинства" class="col-sm-12">{{ old('pros') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="form-field-17" name="cons" placeholder="Недостатки" class="col-sm-12">{{ old('cons') }}</textarea>
                        </div>
                    </div>
