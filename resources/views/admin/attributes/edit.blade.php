        ...
        <div class="row">
            <div class="col-xs-12 ace-thumbnails">
                ...
                <form class="form-horizontal" role="form" action="{{route('admin.attributes.update', $attribute->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-6"> Скрывать в админке </label>
                        <div class="col-sm-9">
                            <label>
                                <input type="hidden" name="hidden" value="0">
                                <input name="hidden" @if ((old() && old('hidden')) || (empty(old()) && $attribute->hidden) ) checked="checked" @endif   value="1" class="ace ace-switch ace-switch-4 btn-empty" type="checkbox">
                                <span class="lbl"></span>
                            </label>
                        </div>
                    </div>
