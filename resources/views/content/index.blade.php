        ...
        <div class="main-find-size__col">
          ...
          <div class="main-find-size-white-block"><img class="main-find-size-white-block__image" src="/img/main-size-girl-opened-mouth-min.jpg" alt="" role="presentation"/>
            <div class="main-find-size-white-block__caption">
              ...
              </div><a class="btn btn_green-border-900 js-action-link" href="#" data-action="{{route('modal')}}" data-modal="sizes">Подобрать одежду</a>
            </div>
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="main-recipes">
      <div class="related-header related-header_xs main-recipes__header">
        ...
        </div><a class="related-header__listing-link" href="#">Читать все статьи<i class="sprite_main sprite_main-icon__arrow_black_to_right"></i></a>
      </div>
      <div class="recipe-articles main-recipes__articles">
        <div class="recipe-article-preview recipe-articles__article"><a class="recipe-article-preview__image" href="#"><img src="/img/main-recipe-1-min.jpg"/></a>
          <div class="recipe-article-preview__caption">
            <div class="recipe-article-preview__title">Овсяно-творожное печенье
            </div>
        ...
        </div><a class="related-header__listing-link sm" href="#">Читать все статьи<i class="sprite_main sprite_main-icon__arrow_black_to_right"></i></a>
      </div>
    </div>
  </div>
</main>
