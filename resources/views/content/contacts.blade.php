            ...
            <div class="container-in contacts">
                ...
                <div class="contacts__get-by">
                    ...
                    <div>
                        ...
                        <div class="contacts__text">
                            Второй вариант, это подземная парковка под мебельным центром ROOMER. Бесплатно 1 час. Выходите из паркинга в мебельный центр, затем на улицу и входите в Бизнес-центр. Далее на лифте на 4й этаж. вдоль стены с окнами проходите 4 офиса.
                        </div>
                    </div>
                </div>
                <!-- How to get scheme -->
